	...
	private void OnTriggerStay(Collider other)
	{
		...
		if (other.gameObject.tag == "playerHitbox")
		{
			...
			if (IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE)
			{
				...
				{
					component.transform.root.GetComponent<HERO>().die((component.transform.root.transform.position - base.transform.position).normalized * b * 1000f + Vector3.up * 50f, false);
				}
			}
		...
		else if (other.gameObject.tag == "titanneck")
		{
			...
			if (IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE)
			{
				if ((bool)component2.transform.root.GetComponent<TITAN>() && !component2.transform.root.GetComponent<TITAN>().hasDie)
				{
					...
					{
						GameObject.Find("MainCamera").GetComponent<IN_GAME_MAIN_CAMERA>().startSnapShot(component2.transform.position, b2, component2.transform.root.gameObject);
					}
			...
			else if (!PhotonNetwork.isMasterClient)
			{
				if ((bool)component2.transform.root.GetComponent<TITAN>())
				{
					if (!component2.transform.root.GetComponent<TITAN>().hasDie)
					{
						...
						if (PlayerPrefs.HasKey("EnableSS") && PlayerPrefs.GetInt("EnableSS") == 1)
						{
							GameObject.Find("MainCamera").GetComponent<IN_GAME_MAIN_CAMERA>().startSnapShot(component2.transform.position, b3, component2.transform.root.gameObject);
			...
			else if ((bool)component2.transform.root.GetComponent<TITAN>())
			{
				if (!component2.transform.root.GetComponent<TITAN>().hasDie)
				{
					...
					if (PlayerPrefs.HasKey("EnableSS") && PlayerPrefs.GetInt("EnableSS") == 1)
					{
						GameObject.Find("MainCamera").GetComponent<IN_GAME_MAIN_CAMERA>().startSnapShot(component2.transform.position, b6, component2.transform.root.gameObject);
					}
			...
			else if ((bool)component2.transform.root.GetComponent<FEMALE_TITAN>())
			{
				...
				if (!component2.transform.root.GetComponent<FEMALE_TITAN>().hasDie)
				{
					...
					if (PlayerPrefs.HasKey("EnableSS") && PlayerPrefs.GetInt("EnableSS") == 1)
					{
						GameObject.Find("MainCamera").GetComponent<IN_GAME_MAIN_CAMERA>().startSnapShot(component2.transform.position, b7);
					}
			...
			else if ((bool)component2.transform.root.GetComponent<COLOSSAL_TITAN>())
			{
				...
				if (!component2.transform.root.GetComponent<COLOSSAL_TITAN>().hasDie)
				{
					...
					if (PlayerPrefs.HasKey("EnableSS") && PlayerPrefs.GetInt("EnableSS") == 1)
					{
						GameObject.Find("MainCamera").GetComponent<IN_GAME_MAIN_CAMERA>().startSnapShot(component2.transform.position, b8);
					}
